...
\begin{itemize}
 \item entspricht dem gemeinsamen Aufbau beider Beispielsysteme, d.h
	\TODO{Strukturbild}
  \item obige Form der ÜF ermöglict ihre graphische Darstellung in der komplexen s-Ebene als PN-Diagramm. 
	\TODO{Bild}
  \item Zusammenhänge zwischen Pol- und Nullstellenlage und Zeitverhalten des Systems. 
  \subitem $ Re p_i < 0 $
  \item Weiterhin Betrachtung der Sprungantwort (bei Annahme endlicher Pole $p_i \not 0 $
	\TODO {Formel}
  \item Zu den Polstellen gehörende Zeitverläufe: siehe \bb{14}
  \item $\rightarrow$ Beiträge stabiler Pole klingen ab, und zwar umso schneller, je weiter links sie liegen.
  \subitem Weit links liegende Pole sind nicht dominant (d.h. nicht prägend für das Zeitverhalten und somit ggf. vernachlässigbar),
	   wohl aber nahe der j-Achse liegende sowie instabile Pole (sofern nicht Nullstellen nahe dabei, was \TODO{Formel}
	   zur Folge hat, falls $n_j = p_\nu$ gilt.
